...
import com.mycompany.FormesCommande.SignInForm;
 ...
 * @author Shai Almog
 */
public class ActivateForm extends BaseFormC {
   ...
   /* public void sendMail(Resources res) {
		...
		props.put("mail.smtps.auth", "true"); //enable authentication
           ...
           String mp = serviceutili.getInstance().getPasswordByEmail(email.getText().toString(), res);//mp taw narj3lo
          ...
          st.connect("smtp.gmail.com",465,"hayacampi@gmail.com","hayacampi12345");
