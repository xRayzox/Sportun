 ...
 * @author Lenovo
 */
public class ListCategorieForm extends BaseFormC{
     Form current;
    public ListCategorieForm(Resources res ) {
        ...
        Display.getInstance().scheduleBackgroundTask(() -> {
           ...
           Display.getInstance().callSerially(() -> {
                //this.removeAll();
          for (Categorie c : new ServiceCategorie().affichageCategories()) {

           // this.add(AjoutCategorieForm(c));
      ...
      /*  System.out.println("user connecté id ="+ SessionManager.getId());
        ...
        ArrayList<Categorie>list = ServiceCategorie.getInstance().affichageCategories();
    ...
    private void addButton(Image img,Categorie rec , Resources res) {
        ...
        Label typeTxt = new Label("Type categorie : "+rec.getType(),"NewsTopLine2");
        Label nameTxt = new Label("Nom categorie : "+rec.getName(),"NewsTopLine2" );
        
        createLineSeparator();
        
       /* if(rec.getName() == null ) {
            nameTxt.setText("non Traitée");
        }
        else 
            nameTxt.setText("Traitée");*/
