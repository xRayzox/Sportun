 ...
 * @author asusS
 */
public class ModifierProduitForm extends BaseFormC {

    Form current;

    public ModifierProduitForm(Resources res, Produit rec) {
...
tb.addSearchCommand(e -> {
        ...
        TextField Nom = new TextField(rec.getName(), "name", 20, TextField.ANY);
        TextField Prix = new TextField(String.valueOf(rec.getPrix()), "prix", 20, TextField.ANY);
        TextField Quantity = new TextField(String.valueOf(rec.getQuantity()), "quantity", 20, TextField.ANY);
        ...
        btnModifier.addPointerPressedListener(l -> {
            ...
            rec.setPrix(Integer.valueOf(Prix.getText()));
            rec.setQuantity(Integer.valueOf(Quantity.getText()));
            rec.setType(Type.getText());
            /// Auto Without Modif
          //  rec.setIdfournisseur(rec.getIdfournisseur());
          //  rec.setImage(String.valueOf(rec.getImage()));
            //

            if (Service_Produit.getInstance().ModifierProduit(rec)) {
                new ListeProduit(res).show();
            }
