 ...
 * @author Lenovo
 */
public class AjoutCategorieForm extends BaseFormC{
  ...
  status.setMessage("categorie ajouteee");
  ...
  System.out.println("Hallo");
        ...
        TextField type = new TextField("", "entrer le type du categorie!!");
        type.setUIID("TextFieldBlack");
        addStringValue("Objet",type);
        
        TextField name = new TextField("", "entrer le nom de la categorie!!");
        name.setUIID("TextFieldBlack");
        addStringValue("Description",name);
            ...
            try {
                ...
                if(type.getText().equals("") || name.getText().equals("")) {
                    ...
                    //njibo iduser men session (current user)
                     Categorie r = new Categorie((String.valueOf(type.getText()
                                  ).toString()),
                    ...
                    ServiceCategorie.getInstance().ajoutCategorie(r);
    ...
    private void addTab(Tabs swipe, Label spacer , Image image, String string, String text, Resources res) {
        ...
        swipe.addTab("",res.getImage("back-logo-n.jpeg"), page1);
