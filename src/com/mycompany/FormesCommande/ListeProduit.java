 ...
 * @author Asus
 */
public class ListeProduit extends BaseFormC{
    
      Form current;

    public ListeProduit(Resources res){
...
Button Share=new Button("Share");
 ...
 liste.addPointerPressedListener(l->{
     Display.getInstance().execute("https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=http%3A%2F%2F127.0.0.1%3A8000%2Fequipe_mobile&display=popup&ref=plugin&src=share_button");
        ...
        ArrayList<Produit>list = Service_Produit.getInstance().findAll();
    ...
    private void addButton(Image img, Produit art,Resources res) {
        ...
        Label dateTxt = new Label("Quantite : "+art.getQuantity(),"NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce Produit ?","Annuler","Oui")){
                ...
                if(Service_Produit.getInstance().deleteProd(art.getId())){
                    new ListeProduit(res).show();
        ...
        lModifier.addPointerPressedListener(l ->{
            System.out.println("");
           new ModifierProduitForm(res, art).show();
