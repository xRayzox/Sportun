 ...
 * @author BLVCK
 */
public class AjouterService extends BaseFormC {

    Form current;

    public AjouterService(Resources res) {
        ...
        addStringValue("title", Type);

        TextField NumTel = new TextField("", "entrer NumTel!!");
        NumTel.setUIID("TextFieldBlack");
        addStringValue("NumTel", NumTel);
        
        TextField lat = new TextField("", "entrer lat!!");
        lat.setUIID("TextFieldBlack");
        addStringValue("lat", lat);
        
        TextField lng = new TextField("", "entrer lng!!");
        lng.setUIID("TextFieldBlack");
        addStringValue("lng", lng);
        
        TextField region = new TextField("", "entrer region!!");
...
Location l = new Location( Float.parseFloat(lat.getText()),
                    ...
                    Services r = new Services(Integer.parseInt(NumTel.getText()),
                    ...
                    ServiceC.getInstance().ajoutService(r);
