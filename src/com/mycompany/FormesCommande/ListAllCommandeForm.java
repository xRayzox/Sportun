...
public class ListAllCommandeForm extends BaseFormC {
    ...
    /*tb.addSearchCommand(e ->  {
        ...
        //-------
        this.add(nom_utilisateur);
        Button btnAjouter = new Button ("search") ;
        this.add(btnAjouter);
    ...
    btnAjouter.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                if(nomcurrent.equals("")) {
                    ...
                    new SearchCommandeForm(res,nomcurrent).show();
                    //--
        ...
        //
        // appel affichage 
    ArrayList <PasserCommande>list = Commande.getInstance().afficherallCommande();
    ...
    private void addButton(Image img , PasserCommande rec,Resources res) {
      ...
      /* TextArea ta=new TextArea(objet);
       ...
       //supprimer button
        ...
        FontImage statImage = FontImage.createMaterial(FontImage.MATERIAL_ACCOUNT_CIRCLE, statStyle);
        ...
        lstat.addPointerPressedListener(l -> {
           ...
           //     dig.dispose();
                ...
                String nomcurrent=rec.getNom_utilisateur().toString();
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(BoxLayout.encloseX(nomText),
                BoxLayout.encloseX(produitText,lSupprimer,lstat),BoxLayout.encloseX(prixtext),BoxLayout.encloseX(line1233)));
