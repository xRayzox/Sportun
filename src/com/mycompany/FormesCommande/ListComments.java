 ...
 * @author alaagha
 */
public class ListComments extends BaseFormC{
    ...
    String imgurl = Statics.BASE_URL+"/upload/images/";
            ...
            Form current;
    public ListComments(Resources res ) {
...
//        Appel affichage methode
        ArrayList<Commentaire>list = ServiceCommentaire.getInstance().affichageComments();
...
//            new ModifierComments(res,rec,ar).show();
//        });
//        
//        
