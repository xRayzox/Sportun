...
import static com.codename1.ui.URLImage.createToStorage;
 ...
 * @author alaagha
 */
public class ListBackArticle extends BaseFormC{
    ...
    String imgurl = Statics.BASE_URL+"/upload/images/";
            ...
            Form current;
    public ListBackArticle(Resources res ) {
        ...
        final Dialog ipDlg = ip.showInifiniteBlocking();
          ...
          ListArticle a = new ListArticle(res);
            a.show();
            refreshTheme();
        });
        ...
        addOrientationListener(e -> {
            updateArrowPosition(barGroup.getRadioButton(barGroup.getSelectedIndex()), arrow);
                ...
                Button btnAnnuler = new Button("Commentaires");
       btnAnnuler.addActionListener(e -> {
           new ListComments(res).show();
       });
      Button btnAnn = new Button("ajouter");
       btnAnn.addActionListener(e -> {
           new AddArticle(res).show();
       });
...
lSupprimer.addPointerPressedListener(l -> {
         ...
         if(ServiceArticle.getInstance().deleteArticle(rec.getId())) {
...
//        });
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(commentairesTxt),
                BoxLayout.encloseX(likeTxt),
               // BoxLayout.encloseX(btnAnnuler),

                       BoxLayout.encloseX(lModifier,lSupprimer)
        ));
        
        
               image.addActionListener(e ->new singleblog(res,rec).show());
