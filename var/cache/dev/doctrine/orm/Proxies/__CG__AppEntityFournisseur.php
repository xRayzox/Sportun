...
class Fournisseur extends \App\Entity\Fournisseur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Fournisseur' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Fournisseur' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Fournisseur' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Fournisseur' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Fournisseur' . "\0" . 'produits'];
        }
     ...
     * {@inheritDoc}
     */
    public function setDescription(string $description): \App\Entity\Fournisseur
    {
