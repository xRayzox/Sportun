...
class Produit extends \App\Entity\Produit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'prix', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'quantity', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'type', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'idfournisseur', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'image', '' . "\0" . 'App\\Entity\\Produit' . "\0" . 'avis'];
        }
     ...
     * {@inheritDoc}
     */
    public function setIdfournisseur(?\App\Entity\Fournisseur $idfournisseur): \App\Entity\Produit
    {
